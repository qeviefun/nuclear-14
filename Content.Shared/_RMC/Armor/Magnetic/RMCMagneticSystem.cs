// #Misfits Add - RMC magnetic system ported from RMC-14 (MIT)
...
public sealed class RMCMagneticSystem : EntitySystem
{
    ...
    private void OnSlingDrop(Entity<RMCSlingPouchComponent> pouch, ref InventoryRelayedEvent<RMCMagnetizeItemEvent> args)
    {
    ...
    private void OnSlingStore(Entity<RMCSlingPouchComponent> ent, ref EntInsertedIntoContainerMessage args)
    {
    ...
    private void OnSlingGetVerbs(Entity<RMCSlingPouchComponent> ent, ref GetVerbsEvent<AlternativeVerb> args)
    {
    ...
    private void OnSlingItemGetVerbs(Entity<RMCSlingPouchItemComponent> ent, ref GetVerbsEvent<AlternativeVerb> args)
    {
        if (!args.CanAccess || !args.CanInteract)
            return;
    ...
    private void OnSlingItemExamine(Entity<RMCSlingPouchItemComponent> ent, ref ExaminedEvent args)
    {
