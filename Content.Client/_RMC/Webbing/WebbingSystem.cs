// #Misfits Add - RMC client webbing system ported from RMC-14 (MIT)
using Content.Client.Clothing;
using Content.Client.Items.Systems;
using Content.Shared._RMC.Webbing;
...
namespace Content.Client._RMC.Webbing;
...
public sealed class WebbingSystem : SharedWebbingSystem
{
    ...
    {
        return comp.Whitelist?.Tags?.Contains("ArmorWebbing") == true
    ...
    {
        var layer = GetWebbingLayer(ent.Comp);
        ...
        {
            webbing.PlayerSprite = new(webbingSprite.BaseRSI?.Path ?? new ResPath("_RMC/Objects/Clothing/Webbing/webbing.rsi"), "equipped");
        }
    ...
    {
        var layer = GetWebbingLayer(clothing.Comp);
        ...
        _itemSystem.VisualsChanged(clothing);
