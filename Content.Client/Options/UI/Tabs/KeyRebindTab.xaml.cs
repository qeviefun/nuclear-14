...
using Content.Shared._RMC.Input; // #Misfits Add - RMC key functions for holster/pickup binds
...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        public KeyRebindTab()
        {
            ...
            // #Misfits Fix - Camera rotation removed from options; provides directional PVP advantage
            ...
            // #Misfits Add - Combat section: gun keybinds and RMC holsters now user-remappable
            AddHeader("ui-options-header-combat");
            AddButton(ContentKeyFunctions.EjectMagazine);
            AddButton(ContentKeyFunctions.ToggleBoltAction);
