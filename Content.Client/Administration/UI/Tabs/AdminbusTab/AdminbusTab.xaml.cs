...
namespace Content.Client.Administration.UI.Tabs.AdminbusTab
{
    ...
    public sealed partial class AdminbusTab : Control
    {
        ...
        public AdminbusTab()
        {
            ...
            SpawnDungeonsButton.OnPressed += SpawnDungeonsButtonOnPressed;
        ...
        private void SpawnDungeonsButtonOnPressed(BaseButton.ButtonEventArgs obj)
        {
            _dungeonSpawnController.ToggleWindow();
        }
