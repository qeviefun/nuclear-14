...
game-ticker-player-join-game-message = Welcome to Misfits Nuclear Wasteland! If this is your first time playing, be sure to read the game rules, and don't be afraid to ask for help in LOOC (local OOC) or OOC (usually available only between rounds).
